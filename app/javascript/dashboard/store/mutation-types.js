export default {
  ...
  // Sidebar Apps
  SET_SIDEBAR_APPS_UI_FLAG: 'SET_SIDEBAR_APPS_UI_FLAG',
  SET_SIDEBAR_APPS: 'SET_SIDEBAR_APPS',
  CREATE_SIDEBAR_APP: 'CREATE_SIDEBAR_APP',
  EDIT_SIDEBAR_APP: 'EDIT_SIDEBAR_APP',
  DELETE_SIDEBAR_APP: 'DELETE_SIDEBAR_APP',

  // Chat Agents
  SET_CHAT_AGENTS_UI_FLAG: 'SET_CHAT_AGENTS_UI_FLAG',
  SET_CHAT_AGENTS: 'SET_CHAT_AGENTS',
  ADD_CHAT_AGENT: 'ADD_CHAT_AGENT',
  EDIT_CHAT_AGENT: 'EDIT_CHAT_AGENT',
  DELETE_CHAT_AGENT: 'DELETE_CHAT_AGENT',
  SET_CHAT_AGENT_MESSAGES: 'SET_CHAT_AGENT_MESSAGES',
  ADD_CHAT_AGENT_MESSAGES: 'ADD_CHAT_AGENT_MESSAGES',
  CLEAR_CHAT_AGENT_MESSAGES: 'CLEAR_CHAT_AGENT_MESSAGES',
  SET_SELECTED_CHAT_AGENT: 'SET_SELECTED_CHAT_AGENT',
