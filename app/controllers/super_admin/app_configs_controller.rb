class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'quepasa' => %w[QUEPASA_API_URL QUEPASA_API_USER],
      'conversation_sidebar' => %w[SIDEBAR_CONVERSATION_ACTIONS SIDEBAR_CONVERSATION_PARTICIPANTS SIDEBAR_CONVERSATION_INFO SIDEBAR_CONTACT_ATTRIBUTES SIDEBAR_PREVIOUS_CONVERSATION SIDEBAR_MACROS SIDEBAR_LINEAR_ISSUES SIDEBAR_SHOPIFY_ORDERS SIDEBAR_CONTACT_NOTES],
      'captain' => %w[CAPTAIN_OPEN_AI_API_KEY CAPTAIN_OPEN_AI_MODEL CAPTAIN_OPEN_AI_ENDPOINT]
    }

    @allowed_configs = mapping.fetch(
      @config,
      %w[ENABLE_ACCOUNT_SIGNUP FIREBASE_PROJECT_ID FIREBASE_CREDENTIALS WHATSAPP_API_PROVIDER WEBHOOK_TIMEOUT MAXIMUM_FILE_UPLOAD_SIZE WIDGET_TOKEN_EXPIRY]
    )
  end
end
